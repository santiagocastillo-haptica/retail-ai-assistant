...
nivel de delegación en la app y su forma de planificar la compra: La Mamá Ocupada y
Pragmática, El Curador Gastronómico Experiencial, El Planificador Mensual Sistemático y La
Cazadora de Ofertas por Impulso y Memoria.

- Los 4 agentes están poblados con datos de perfilación de comportamiento (hábitos de
...
de su configuración — para reactivarlo, quita el campo o ponlo en `true`. Hoy los 4 agentes
están activos.
